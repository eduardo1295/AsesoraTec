...
<body>
        ...
        <div class="row">
            <table class="table table-responsive w-50 ">
                <thead class="justify-content-center">
                    <tr>
                        <th class="lead">Número de control</th>
                        <th class="lead">Apellidos</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="defaultChecked2">Hoy</label>
                            </div>
                        </td>
    ...
    <div class="row justify-content-center">
            <button type="submit" value="" id="registrarbtn" class="btn btn-primary lead mx-4"><i class="fas fa fa-list-ol lead"> Generar documento</i></button>
            <button type="submit" value="" id="registrarbtn" class="btn btn-primary lead mx-4"><i class="fas fa fa-mail-reply lead" onclick="window.location.href='verasesorias.html'"> Página anterior</i></button>
    </div>
</body>

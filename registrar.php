...
<body class="contenedor">
    ...
    <div class="mb-2 mt-2 container w-100">
        <div class="row  justify-content-center">
            <button type="submit" value="Registrarme" id="registrara" class="btn btn-primary lead w-50" data-toggle="modal" data-target="#mensaje">Registrarme <i class="fa fa-male"></i></button>
